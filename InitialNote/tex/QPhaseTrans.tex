...
\begin{figure}[!h]
	...
	\label{fig:f(n)_SF} 
\end{figure}
For large systems the dispersion relation of the superfluid state (equation \eqref{SFenergy}) is continues. In other words, the spectrum is \textit{gapless}, since excitations with any energy are possible.
